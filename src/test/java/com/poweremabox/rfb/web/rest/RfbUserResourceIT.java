...
class RfbUserResourceIT {
    ...
    public static RfbUser createEntity(EntityManager em) {
        RfbUser rfbUser = new RfbUser().userName(DEFAULT_USER_NAME);
        return rfbUser;
    }
    ...
    public static RfbUser createUpdatedEntity(EntityManager em) {
        RfbUser rfbUser = new RfbUser().userName(UPDATED_USER_NAME);
        return rfbUser;
    }
    ...
    void putNewRfbUser() throws Exception {
        ...
        updatedRfbUser.userName(UPDATED_USER_NAME);
    ...
    void fullUpdateRfbUserWithPatch() throws Exception {
        ...
        partialUpdatedRfbUser.userName(UPDATED_USER_NAME);
