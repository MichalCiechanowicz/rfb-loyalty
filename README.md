[![CircleCI](https://circleci.com/gh/MichalCiechanowicz/rfb-loyalty/tree/main.svg?style=svg)](https://circleci.com/gh/MichalCiechanowicz/rfb-loyalty/tree/main)
...
To build the final jar and optimize the rfb application for production, run:
